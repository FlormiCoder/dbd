...
bot.command({
   ...
   code: `
$deletecommand
$giveRole[$authorID;899776057375338547]
$onlyForServer[878738630053597204;etc;Использовать эту команду можно только на оффициальном сервере поддержки бота]
$onlyIf[$message==$discriminator[$authorID];****вы указали не свой тег или проверьте правильность написания тега. *вер 9643]
$argsCheck[1;Укажите свой тег]
$title[успешно]
$description[$username верифицирован]
$color[00ff66]`
})
